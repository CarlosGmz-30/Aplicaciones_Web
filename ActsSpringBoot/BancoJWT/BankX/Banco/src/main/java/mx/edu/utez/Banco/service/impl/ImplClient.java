...
public class ImplClient implements IClient {
    ...
    public ClientBean save(ClientDto clientDto) {
        ...
        clients.add(client);
        cardDao.findAllById(clientDto.getCards()).forEach(card -> { //Card es el objeto que requiere el foreach         //Busca la lista de tarjetas con respecto al id del cliente
